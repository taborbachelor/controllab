...
### Phase 3 — Testing / commissioning scenarios (in progress)
...
- ⬜ **Step 2 — a scenario for every interlock in §6.3** — an interlock without a test is an untested claim.
- ⬜ **Step 3 — the interlock coverage matrix**, cross-referencing scenarios' `interlock:` field (already part of the format) against §6.3's full list, surfacing gaps.
