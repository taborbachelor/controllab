...
- 60 scenarios covering all 17 interlocks in the spec, in Auto, Manual
...
- Mass is conserved to the milligram and checked on every scan, and every
  ...
  time.
- 925 automated tests, run on every push (Python 3.12 and 3.13; the badge
...
The repository has 60 scenarios covering all 17 interlock rows of the
...
All roadmap phases are complete, and 925 tests pass.
